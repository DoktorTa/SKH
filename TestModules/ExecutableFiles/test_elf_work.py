...
class TestELFWork(unittest.TestCase):
    ...
    def test_get_table_hendler(self):
        ...
        answer = [
            ...
            {'p_type': 1, 'p_flags': 4, 'p_offset': 0, 'p_vaddr': 0,
             ...
             'p_align': 4096},
            {'p_type': 1, 'p_flags': 5, 'p_offset': 16384, 'p_vaddr': 16384,
             'p_paddr': 16384, 'p_filesz': 76873, 'p_memsz': 76873,
             'p_align': 4096}
        ]
    ...
    def test_get_section_table(self):
        ...
        answer = [
            ...
            {'sh_name': 'note.gnu.build-id\x00', 'sh_type': 7, 'sh_flags': 2,
             'sh_addr': 708, 'sh_offset': 708, 'sh_size': 36, 'sh_link': 0,
            ...
            {'sh_name': 'note.ABI-tag\x00', 'sh_type': 7, 'sh_flags': 2,
             ...
             'sh_info': 0, 'sh_addralign': 4, 'sh_entsize': 0},
            {'sh_name': 'gnu.hash\x00', 'sh_type': 1879048182, 'sh_flags': 2,
             'sh_addr': 776, 'sh_offset': 776, 'sh_size': 172, 'sh_link': 5,
             'sh_info': 0, 'sh_addralign': 8, 'sh_entsize': 0},
            {'sh_name': 'dynsym\x00', 'sh_type': 11, 'sh_flags': 2,
             'sh_addr': 952, 'sh_offset': 952, 'sh_size': 3096, 'sh_link': 6,
             'sh_info': 1, 'sh_addralign': 8, 'sh_entsize': 24},
            {'sh_name': 'dynstr\x00', 'sh_type': 3, 'sh_flags': 2,
             'sh_addr': 4048, 'sh_offset': 4048, 'sh_size': 1460,
             'sh_link': 0, 'sh_info': 0, 'sh_addralign': 1, 'sh_entsize': 0},
            {'sh_name': 'gnu.version\x00', 'sh_type': 1879048191,
             'sh_flags': 2, 'sh_addr': 5508, 'sh_offset': 5508,
             'sh_size': 258, 'sh_link': 5, 'sh_info': 0, 'sh_addralign': 2,
             'sh_entsize': 2},
            {'sh_name': 'gnu.version_r\x00', 'sh_type': 1879048190,
             'sh_flags': 2, 'sh_addr': 5768, 'sh_offset': 5768,
             'sh_size': 112, 'sh_link': 6, 'sh_info': 1, 'sh_addralign': 8,
             'sh_entsize': 0},
            {'sh_name': 'rela.dyn\x00', 'sh_type': 4, 'sh_flags': 2,
             'sh_addr': 5880, 'sh_offset': 5880, 'sh_size': 4944,
             'sh_link': 5, 'sh_info': 0, 'sh_addralign': 8, 'sh_entsize': 24},
            {'sh_name': 'rela.plt\x00', 'sh_type': 4, 'sh_flags': 66,
             'sh_addr': 10824, 'sh_offset': 10824, 'sh_size': 2544,
             'sh_link': 5, 'sh_info': 24, 'sh_addralign': 8, 'sh_entsize': 24}
        ]
