...
class TestELFReader(unittest.TestCase):
    ...
    def test_program_header_section_read(self):
        ...
        with open(r"A:\Programming languages\In developing\Python\SKH\TestModules\ExecutableFiles\ls.elf", "rb") as file:
            ...
            for inc in range(5):
                ...
                self.assertEqual(tables_header, str(section_header_records_answer[inc]))
    ...
    def test_program_header_table_read(self):
        ...
        with open(r"A:\Programming languages\In developing\Python\SKH\TestModules\ExecutableFiles\ls.elf", "rb") as file:
            ...
            for inc in range(5):
                ...
                self.assertEqual(tables_header, str(tables_header_records_answer[inc]))
    ...
    def test_program_header_table_init(self):
        ...
        for inc in range(8):
            self.assertEqual(table_header.program_header_fields.get(key[inc]), answer[inc])
