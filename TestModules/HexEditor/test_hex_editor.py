...
class TestHexPresentor(unittest.TestCase):
    ...
    def test_row_creator(self):
        ...
        self.assertEqual(hex_e._row_creator(5, 16, 0), (answer[0], 5))
        self.assertEqual(hex_e._row_creator(8, 8, 0), (answer[1], 8))
        self.assertEqual(hex_e._row_creator(4, 32, 1), (answer[2], 5))
        self.assertEqual(hex_e._row_creator(4, 4, 1), (answer[3], 5))
    ...
    def test_ascii_creator(self):
        ...
        answer = [[['\x00', '\x01', '\x02', '\x03', '\x04', '\x05', '\x06', '\x07', '\x08', '\t', '\n', '\x0b', '\x0c', '\r', '\x0e', '\x0f'],
    ...
    def test_hex_presentor(self):
        ...
        for inc in range(4):
            self.assertEqual(hex_e._hex_creator(data[inc], steps[inc]), answer[inc])
