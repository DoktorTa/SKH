class ELFHeaderSection:
    """
        ...
        Пожалйуста не используйте значения этих заголовках вне модуля, и не добавляете из других компанент,
...
class ELFData:
    """
        Класс который содержит информацию о заголовке, секциях и заголовках в elf файле.
